...
int main() {
    ...
    printf("\nValue of num1 is %.1f and is stored in address %p.", num1, (void*)ptr_num1);

    printf("\nValue of num2 is %.1f and is stored in address %p.", num2, (void*)ptr_num2);
    ...
    printf(*ptr_num1 == *ptr_num2 ?
        ...
        "\nThe values pointed by the pointers are not equal");
